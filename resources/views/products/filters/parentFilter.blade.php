<div class="sidebar__categories">
    ...
    <div class="categories__accordion">
        <div class="accordion">
            ...
            <div class="mb-3 text-xl font-bold text-gray-800">
                <p>{{$parent_category->getTranslatedAttribute('name')}}</p>
            </div>
...
<form id="productFilter" action="{{route('product.category.parent',['slugName' => $category->slug,'parentSlug'=>$parent_category->slug])}}" method="GET">
